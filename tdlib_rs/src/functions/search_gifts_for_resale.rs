...
pub async fn search_gifts_for_resale(
    gift_id: i64,
    order: crate::enums::GiftForResaleOrder,
    for_crafting: bool,
    attributes: Vec<crate::enums::UpgradedGiftAttributeId>,
    offset: String,
    limit: i32,
    client_id: i32,
) -> Result<crate::enums::GiftsForResale, crate::types::Error> {
    let request = json!({
