...
pub async fn get_web_app_link_url(chat_id: i64, bot_user_id: i64, web_app_short_name: String, start_parameter: String, allow_write_access: bool, parameters: crate::types::WebAppOpenParameters, client_id: i32) -> Result<crate::enums::HttpUrl, crate::types::Error> {
    let request = json!({
