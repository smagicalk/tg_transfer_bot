...
pub async fn summarize_message(chat_id: i64, message_id: i64, translate_to_language_code: String, client_id: i32) -> Result<crate::enums::FormattedText, crate::types::Error> {
    let request = json!({
