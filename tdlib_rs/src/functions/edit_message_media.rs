...
pub async fn edit_message_media(chat_id: i64, message_id: i64, input_message_content: crate::enums::InputMessageContent, client_id: i32) -> Result<crate::enums::Message, crate::types::Error> {
    let request = json!({
