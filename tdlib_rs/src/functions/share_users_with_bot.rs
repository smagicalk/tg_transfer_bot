...
pub async fn share_users_with_bot(chat_id: i64, message_id: i64, button_id: i32, shared_user_ids: Vec<i64>, only_check: bool, client_id: i32) -> Result<(), crate::types::Error> {
    let request = json!({
