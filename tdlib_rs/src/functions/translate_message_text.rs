...
pub async fn translate_message_text(chat_id: i64, message_id: i64, to_language_code: String, client_id: i32) -> Result<crate::enums::FormattedText, crate::types::Error> {
    let request = json!({
