...
pub async fn create_new_sticker_set(user_id: i64, title: String, name: String, sticker_type: crate::enums::StickerType, needs_repainting: bool, stickers: Vec<crate::types::InputSticker>, source: String, client_id: i32) -> Result<crate::enums::StickerSet, crate::types::Error> {
    let request = json!({
