...
pub async fn set_authentication_premium_purchase_transaction(transaction: crate::enums::StoreTransaction, is_restore: bool, currency: String, amount: i64, client_id: i32) -> Result<(), crate::types::Error> {
    let request = json!({
