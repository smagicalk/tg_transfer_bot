...
pub async fn upgrade_gift(received_gift_id: String, keep_original_details: bool, star_count: i64, client_id: i32) -> Result<crate::enums::UpgradeGiftResult, crate::types::Error> {
    let request = json!({
        "@type": "upgradeGift",
