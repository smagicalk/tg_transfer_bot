...
pub async fn get_web_app_url(bot_user_id: i64, url: String, parameters: crate::types::WebAppOpenParameters, client_id: i32) -> Result<crate::enums::HttpUrl, crate::types::Error> {
    let request = json!({
        "@type": "getWebAppUrl",
