...
pub enum CheckChatUsernameResult {
    ...
    #[serde(rename(
        serialize = "checkChatUsernameResultUsernamePurchasable",
        deserialize = "checkChatUsernameResultUsernamePurchasable"
    ))]
    UsernamePurchasable,
    /// The user has too many chats with username, one of them must be made private first
    #[serde(rename(
        serialize = "checkChatUsernameResultPublicChatsTooMany",
        deserialize = "checkChatUsernameResultPublicChatsTooMany"
    ))]
    PublicChatsTooMany,
