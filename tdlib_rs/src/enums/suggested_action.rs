...
pub enum SuggestedAction {
    ...
    #[serde(rename(
        serialize = "suggestedActionUpgradePremium",
        deserialize = "suggestedActionUpgradePremium"
    ))]
    UpgradePremium,
    /// Suggests the user to restore a recently expired Premium subscription
    #[serde(rename(
        serialize = "suggestedActionRestorePremium",
        deserialize = "suggestedActionRestorePremium"
    ))]
    RestorePremium,
    /// Suggests the user to subscribe to the Premium subscription with annual payments
    #[serde(rename(
        serialize = "suggestedActionSubscribeToAnnualPremium",
        deserialize = "suggestedActionSubscribeToAnnualPremium"
    ))]
    SubscribeToAnnualPremium,
    /// Suggests the user to gift Telegram Premium to friends for Christmas
    #[serde(rename(
        serialize = "suggestedActionGiftPremiumForChristmas",
        deserialize = "suggestedActionGiftPremiumForChristmas"
    ))]
    GiftPremiumForChristmas,
    /// Suggests the user to set birthdate
    #[serde(rename(
        serialize = "suggestedActionSetBirthdate",
        deserialize = "suggestedActionSetBirthdate"
    ))]
    SetBirthdate,
    /// Suggests the user to set profile photo
    #[serde(rename(
        serialize = "suggestedActionSetProfilePhoto",
        deserialize = "suggestedActionSetProfilePhoto"
    ))]
    SetProfilePhoto,
    /// Suggests the user to extend their expiring Telegram Premium subscription
    #[serde(rename(
        serialize = "suggestedActionExtendPremium",
        deserialize = "suggestedActionExtendPremium"
    ))]
    ...
    #[serde(rename(
        serialize = "suggestedActionExtendStarSubscriptions",
        deserialize = "suggestedActionExtendStarSubscriptions"
    ))]
    ExtendStarSubscriptions,
    /// A custom suggestion to be shown at the top of the chat list
    #[serde(rename(
        serialize = "suggestedActionCustom",
        deserialize = "suggestedActionCustom"
    ))]
    ...
    #[serde(rename(
        serialize = "suggestedActionSetLoginEmailAddress",
        deserialize = "suggestedActionSetLoginEmailAddress"
    ))]
    ...
    #[serde(rename(
        serialize = "suggestedActionAddLoginPasskey",
        deserialize = "suggestedActionAddLoginPasskey"
    ))]
    AddLoginPasskey,
}
