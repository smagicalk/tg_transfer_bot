...
pub enum PushMessageContent {
    ...
    #[serde(rename(
        serialize = "pushMessageContentPaidMedia",
        deserialize = "pushMessageContentPaidMedia"
    ))]
    ...
    #[serde(rename(
        serialize = "pushMessageContentPremiumGiftCode",
        deserialize = "pushMessageContentPremiumGiftCode"
    ))]
    PremiumGiftCode(crate::types::PushMessageContentPremiumGiftCode),
    /// A message with a giveaway
    #[serde(rename(
        serialize = "pushMessageContentGiveaway",
        deserialize = "pushMessageContentGiveaway"
    ))]
    Giveaway(crate::types::PushMessageContentGiveaway),
    /// A message with a gift
    #[serde(rename(
        serialize = "pushMessageContentGift",
        deserialize = "pushMessageContentGift"
    ))]
    Gift(crate::types::PushMessageContentGift),
    /// A message with an upgraded gift
    #[serde(rename(
        serialize = "pushMessageContentUpgradedGift",
        deserialize = "pushMessageContentUpgradedGift"
    ))]
    ...
    #[serde(rename(
        serialize = "pushMessageContentStory",
        deserialize = "pushMessageContentStory"
    ))]
    ...
    #[serde(rename(
        serialize = "pushMessageContentChecklist",
        deserialize = "pushMessageContentChecklist"
    ))]
    ...
    #[serde(rename(
        serialize = "pushMessageContentVideoChatStarted",
        deserialize = "pushMessageContentVideoChatStarted"
    ))]
    VideoChatStarted,
    /// A video chat or live stream has ended
    #[serde(rename(
        serialize = "pushMessageContentVideoChatEnded",
        deserialize = "pushMessageContentVideoChatEnded"
    ))]
    VideoChatEnded,
    /// An invitation of participants to a video chat or live stream
    #[serde(rename(
        serialize = "pushMessageContentInviteVideoChatParticipants",
        deserialize = "pushMessageContentInviteVideoChatParticipants"
    ))]
    ...
    #[serde(rename(
        serialize = "pushMessageContentChatSetBackground",
        deserialize = "pushMessageContentChatSetBackground"
    ))]
    ChatSetBackground(crate::types::PushMessageContentChatSetBackground),
    /// A chat theme was edited
    #[serde(rename(
        serialize = "pushMessageContentChatSetTheme",
        deserialize = "pushMessageContentChatSetTheme"
    ))]
    ...
    #[serde(rename(
        serialize = "pushMessageContentChatJoinByRequest",
        deserialize = "pushMessageContentChatJoinByRequest"
    ))]
    ChatJoinByRequest,
    /// A new recurring payment was made by the current user
    #[serde(rename(
        serialize = "pushMessageContentRecurringPayment",
        deserialize = "pushMessageContentRecurringPayment"
    ))]
    RecurringPayment(crate::types::PushMessageContentRecurringPayment),
    /// A profile photo was suggested to the user
    #[serde(rename(
        serialize = "pushMessageContentSuggestProfilePhoto",
        deserialize = "pushMessageContentSuggestProfilePhoto"
    ))]
    SuggestProfilePhoto,
    /// A birthdate was suggested to be set
    #[serde(rename(
        serialize = "pushMessageContentSuggestBirthdate",
        deserialize = "pushMessageContentSuggestBirthdate"
    ))]
    SuggestBirthdate,
    /// A user in the chat came within proximity alert range from the current user
    #[serde(rename(
        serialize = "pushMessageContentProximityAlertTriggered",
        deserialize = "pushMessageContentProximityAlertTriggered"
    ))]
    ProximityAlertTriggered(crate::types::PushMessageContentProximityAlertTriggered),
    /// Some tasks were added to a checklist
    #[serde(rename(
        serialize = "pushMessageContentChecklistTasksAdded",
        deserialize = "pushMessageContentChecklistTasksAdded"
    ))]
    ChecklistTasksAdded(crate::types::PushMessageContentChecklistTasksAdded),
    /// Some tasks from a checklist were marked as done or not done
    #[serde(rename(
        serialize = "pushMessageContentChecklistTasksDone",
        deserialize = "pushMessageContentChecklistTasksDone"
    ))]
