...
pub enum ReportChatResult {
    ...
    #[serde(rename(
        serialize = "reportChatResultOptionRequired",
        deserialize = "reportChatResultOptionRequired"
    ))]
    OptionRequired(crate::types::ReportChatResultOptionRequired),
    /// The user must add additional text details to the report
    #[serde(rename(
        serialize = "reportChatResultTextRequired",
        deserialize = "reportChatResultTextRequired"
    ))]
    ...
    #[serde(rename(
        serialize = "reportChatResultMessagesRequired",
        deserialize = "reportChatResultMessagesRequired"
    ))]
    MessagesRequired,
}
