...
pub enum Update {
    ...
    #[serde(rename(serialize = "updatePendingTextMessage", deserialize = "updatePendingTextMessage"))]
    ...
    ApplicationRecaptchaVerificationRequired(crate::types::UpdateApplicationRecaptchaVerificationRequired),
    ...
    #[serde(rename(serialize = "updateTonRevenueStatus", deserialize = "updateTonRevenueStatus"))]
