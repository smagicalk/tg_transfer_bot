...
pub enum SuggestedPostRefundReason {
    ...
    #[serde(rename(
        serialize = "suggestedPostRefundReasonPostDeleted",
        deserialize = "suggestedPostRefundReasonPostDeleted"
    ))]
    PostDeleted,
    /// The post was refunded, because the payment for the post was refunded
    #[serde(rename(
        serialize = "suggestedPostRefundReasonPaymentRefunded",
        deserialize = "suggestedPostRefundReasonPaymentRefunded"
    ))]
    PaymentRefunded,
}
