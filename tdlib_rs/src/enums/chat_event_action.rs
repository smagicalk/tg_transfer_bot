...
pub enum ChatEventAction {
    ...
    #[serde(rename(
        serialize = "chatEventMemberJoinedByInviteLink",
        deserialize = "chatEventMemberJoinedByInviteLink"
    ))]
    ChatEventMemberJoinedByInviteLink(crate::types::ChatEventMemberJoinedByInviteLink),
    /// A new member was accepted to the chat by an administrator
    #[serde(rename(
        serialize = "chatEventMemberJoinedByRequest",
        deserialize = "chatEventMemberJoinedByRequest"
    ))]
    ...
    #[serde(rename(
        serialize = "chatEventMemberTagChanged",
        deserialize = "chatEventMemberTagChanged"
    ))]
    ChatEventMemberTagChanged(crate::types::ChatEventMemberTagChanged),
    /// A chat member extended their subscription to the chat
    #[serde(rename(
        serialize = "chatEventMemberSubscriptionExtended",
        deserialize = "chatEventMemberSubscriptionExtended"
    ))]
    ChatEventMemberSubscriptionExtended(crate::types::ChatEventMemberSubscriptionExtended),
    /// The chat available reactions were changed
    #[serde(rename(
        serialize = "chatEventAvailableReactionsChanged",
        deserialize = "chatEventAvailableReactionsChanged"
    ))]
    ChatEventAvailableReactionsChanged(crate::types::ChatEventAvailableReactionsChanged),
    /// The chat background was changed
    #[serde(rename(
        serialize = "chatEventBackgroundChanged",
        deserialize = "chatEventBackgroundChanged"
    ))]
    ...
    #[serde(rename(
        serialize = "chatEventEmojiStatusChanged",
        deserialize = "chatEventEmojiStatusChanged"
    ))]
    ...
    #[serde(rename(
        serialize = "chatEventMessageAutoDeleteTimeChanged",
        deserialize = "chatEventMessageAutoDeleteTimeChanged"
    ))]
    ...
    #[serde(rename(
        serialize = "chatEventCustomEmojiStickerSetChanged",
        deserialize = "chatEventCustomEmojiStickerSetChanged"
    ))]
    ...
    #[serde(rename(
        serialize = "chatEventActiveUsernamesChanged",
        deserialize = "chatEventActiveUsernamesChanged"
    ))]
    ChatEventActiveUsernamesChanged(crate::types::ChatEventActiveUsernamesChanged),
    /// The chat accent color or background custom emoji were changed
    #[serde(rename(
        serialize = "chatEventAccentColorChanged",
        deserialize = "chatEventAccentColorChanged"
    ))]
    ChatEventAccentColorChanged(crate::types::ChatEventAccentColorChanged),
    /// The chat's profile accent color or profile background custom emoji were changed
    #[serde(rename(
        serialize = "chatEventProfileAccentColorChanged",
        deserialize = "chatEventProfileAccentColorChanged"
    ))]
    ChatEventProfileAccentColorChanged(crate::types::ChatEventProfileAccentColorChanged),
    /// The has_protected_content setting of a channel was toggled
    #[serde(rename(
        serialize = "chatEventHasProtectedContentToggled",
        deserialize = "chatEventHasProtectedContentToggled"
    ))]
    ...
    #[serde(rename(
        serialize = "chatEventHasAggressiveAntiSpamEnabledToggled",
        deserialize = "chatEventHasAggressiveAntiSpamEnabledToggled"
    ))]
    ChatEventHasAggressiveAntiSpamEnabledToggled(
        crate::types::ChatEventHasAggressiveAntiSpamEnabledToggled,
    ),
    ...
    #[serde(rename(
        serialize = "chatEventShowMessageSenderToggled",
        deserialize = "chatEventShowMessageSenderToggled"
    ))]
    ...
    #[serde(rename(
        serialize = "chatEventAutomaticTranslationToggled",
        deserialize = "chatEventAutomaticTranslationToggled"
    ))]
    ChatEventAutomaticTranslationToggled(crate::types::ChatEventAutomaticTranslationToggled),
    /// A chat invite link was edited
    #[serde(rename(
        serialize = "chatEventInviteLinkEdited",
        deserialize = "chatEventInviteLinkEdited"
    ))]
    ChatEventInviteLinkEdited(crate::types::ChatEventInviteLinkEdited),
    /// A chat invite link was revoked
    #[serde(rename(
        serialize = "chatEventInviteLinkRevoked",
        deserialize = "chatEventInviteLinkRevoked"
    ))]
    ChatEventInviteLinkRevoked(crate::types::ChatEventInviteLinkRevoked),
    /// A revoked chat invite link was deleted
    #[serde(rename(
        serialize = "chatEventInviteLinkDeleted",
        deserialize = "chatEventInviteLinkDeleted"
    ))]
    ChatEventInviteLinkDeleted(crate::types::ChatEventInviteLinkDeleted),
    /// A video chat was created
    #[serde(rename(
        serialize = "chatEventVideoChatCreated",
        deserialize = "chatEventVideoChatCreated"
    ))]
    ChatEventVideoChatCreated(crate::types::ChatEventVideoChatCreated),
    /// A video chat was ended
    #[serde(rename(
        serialize = "chatEventVideoChatEnded",
        deserialize = "chatEventVideoChatEnded"
    ))]
    ChatEventVideoChatEnded(crate::types::ChatEventVideoChatEnded),
    /// The mute_new_participants setting of a video chat was toggled
    #[serde(rename(
        serialize = "chatEventVideoChatMuteNewParticipantsToggled",
        deserialize = "chatEventVideoChatMuteNewParticipantsToggled"
    ))]
    ChatEventVideoChatMuteNewParticipantsToggled(
        crate::types::ChatEventVideoChatMuteNewParticipantsToggled,
    ),
    /// A video chat participant was muted or unmuted
    #[serde(rename(
        serialize = "chatEventVideoChatParticipantIsMutedToggled",
        deserialize = "chatEventVideoChatParticipantIsMutedToggled"
    ))]
    ChatEventVideoChatParticipantIsMutedToggled(
        crate::types::ChatEventVideoChatParticipantIsMutedToggled,
    ),
    /// A video chat participant volume level was changed
    #[serde(rename(
        serialize = "chatEventVideoChatParticipantVolumeLevelChanged",
        deserialize = "chatEventVideoChatParticipantVolumeLevelChanged"
    ))]
    ChatEventVideoChatParticipantVolumeLevelChanged(
        crate::types::ChatEventVideoChatParticipantVolumeLevelChanged,
    ),
    /// The is_forum setting of a channel was toggled
    #[serde(rename(
        serialize = "chatEventIsForumToggled",
        deserialize = "chatEventIsForumToggled"
    ))]
    ChatEventIsForumToggled(crate::types::ChatEventIsForumToggled),
    /// A new forum topic was created
    #[serde(rename(
        serialize = "chatEventForumTopicCreated",
        deserialize = "chatEventForumTopicCreated"
    ))]
    ChatEventForumTopicCreated(crate::types::ChatEventForumTopicCreated),
    /// A forum topic was edited
    #[serde(rename(
        serialize = "chatEventForumTopicEdited",
        deserialize = "chatEventForumTopicEdited"
    ))]
    ChatEventForumTopicEdited(crate::types::ChatEventForumTopicEdited),
    /// A forum topic was closed or reopened
    #[serde(rename(
        serialize = "chatEventForumTopicToggleIsClosed",
        deserialize = "chatEventForumTopicToggleIsClosed"
    ))]
    ChatEventForumTopicToggleIsClosed(crate::types::ChatEventForumTopicToggleIsClosed),
    /// The General forum topic was hidden or unhidden
    #[serde(rename(
        serialize = "chatEventForumTopicToggleIsHidden",
        deserialize = "chatEventForumTopicToggleIsHidden"
    ))]
    ChatEventForumTopicToggleIsHidden(crate::types::ChatEventForumTopicToggleIsHidden),
    /// A forum topic was deleted
    #[serde(rename(
        serialize = "chatEventForumTopicDeleted",
        deserialize = "chatEventForumTopicDeleted"
    ))]
    ChatEventForumTopicDeleted(crate::types::ChatEventForumTopicDeleted),
    /// A pinned forum topic was changed
    #[serde(rename(
        serialize = "chatEventForumTopicPinned",
        deserialize = "chatEventForumTopicPinned"
    ))]
