...
pub enum GiftForResaleOrder {
    ...
    #[serde(rename(
        serialize = "giftForResaleOrderPrice",
        deserialize = "giftForResaleOrderPrice"
    ))]
    Price,
    /// The gifts will be sorted by the last date when their price was changed from the newest to the oldest
    #[serde(rename(
        serialize = "giftForResaleOrderPriceChangeDate",
        deserialize = "giftForResaleOrderPriceChangeDate"
    ))]
    PriceChangeDate,
    /// The gifts will be sorted by their number from the smallest to the largest
    #[serde(rename(
        serialize = "giftForResaleOrderNumber",
        deserialize = "giftForResaleOrderNumber"
    ))]
    Number,
}
