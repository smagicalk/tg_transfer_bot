...
pub enum MessageReadDate {
    ...
    #[serde(rename(
        serialize = "messageReadDateUnread",
        deserialize = "messageReadDateUnread"
    ))]
    Unread,
    /// The message is too old to get read date
    #[serde(rename(
        serialize = "messageReadDateTooOld",
        deserialize = "messageReadDateTooOld"
    ))]
    TooOld,
    /// The read date is unknown due to privacy settings of the other user
    #[serde(rename(
        serialize = "messageReadDateUserPrivacyRestricted",
        deserialize = "messageReadDateUserPrivacyRestricted"
    ))]
    ...
    #[serde(rename(
        serialize = "messageReadDateMyPrivacyRestricted",
        deserialize = "messageReadDateMyPrivacyRestricted"
    ))]
    MyPrivacyRestricted,
}
