...
pub enum InviteGroupCallParticipantResult {
    ...
    #[serde(rename(
        serialize = "inviteGroupCallParticipantResultUserPrivacyRestricted",
        deserialize = "inviteGroupCallParticipantResultUserPrivacyRestricted"
    ))]
    UserPrivacyRestricted,
    /// The user can't be invited because they are already a participant of the call
    #[serde(rename(
        serialize = "inviteGroupCallParticipantResultUserAlreadyParticipant",
        deserialize = "inviteGroupCallParticipantResultUserAlreadyParticipant"
    ))]
    ...
    #[serde(rename(
        serialize = "inviteGroupCallParticipantResultUserWasBanned",
        deserialize = "inviteGroupCallParticipantResultUserWasBanned"
    ))]
    UserWasBanned,
    ...
    #[serde(rename(
        serialize = "inviteGroupCallParticipantResultSuccess",
        deserialize = "inviteGroupCallParticipantResultSuccess"
    ))]
