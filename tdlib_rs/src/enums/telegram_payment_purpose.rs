...
pub enum TelegramPaymentPurpose {
    ...
    #[serde(rename(
        serialize = "telegramPaymentPurposePremiumGift",
        deserialize = "telegramPaymentPurposePremiumGift"
    ))]
    ...
    #[serde(rename(
        serialize = "telegramPaymentPurposePremiumGiftCodes",
        deserialize = "telegramPaymentPurposePremiumGiftCodes"
    ))]
    PremiumGiftCodes(crate::types::TelegramPaymentPurposePremiumGiftCodes),
    /// The user creating a Telegram Premium giveaway
    #[serde(rename(
        serialize = "telegramPaymentPurposePremiumGiveaway",
        deserialize = "telegramPaymentPurposePremiumGiveaway"
    ))]
    PremiumGiveaway(crate::types::TelegramPaymentPurposePremiumGiveaway),
    /// The user buying Telegram Stars
    #[serde(rename(
        serialize = "telegramPaymentPurposeStars",
        deserialize = "telegramPaymentPurposeStars"
    ))]
    Stars(crate::types::TelegramPaymentPurposeStars),
    /// The user buying Telegram Stars for other users
    #[serde(rename(
        serialize = "telegramPaymentPurposeGiftedStars",
        deserialize = "telegramPaymentPurposeGiftedStars"
    ))]
    GiftedStars(crate::types::TelegramPaymentPurposeGiftedStars),
    /// The user creating a Telegram Star giveaway
    #[serde(rename(
        serialize = "telegramPaymentPurposeStarGiveaway",
        deserialize = "telegramPaymentPurposeStarGiveaway"
    ))]
    ...
    #[serde(rename(
        serialize = "telegramPaymentPurposeJoinChat",
        deserialize = "telegramPaymentPurposeJoinChat"
    ))]
