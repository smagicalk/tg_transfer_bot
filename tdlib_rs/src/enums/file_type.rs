...
pub enum FileType {
    ...
    #[serde(rename(
        serialize = "fileTypeNotificationSound",
        deserialize = "fileTypeNotificationSound"
    ))]
    NotificationSound,
    /// The file is a photo
    ...
    #[serde(rename(
        serialize = "fileTypeSelfDestructingPhoto",
        deserialize = "fileTypeSelfDestructingPhoto"
    ))]
    SelfDestructingPhoto,
    /// The file is a self-destructing video in a private chat
    #[serde(rename(
        serialize = "fileTypeSelfDestructingVideo",
        deserialize = "fileTypeSelfDestructingVideo"
    ))]
    SelfDestructingVideo,
    /// The file is a self-destructing video note in a private chat
    #[serde(rename(
        serialize = "fileTypeSelfDestructingVideoNote",
        deserialize = "fileTypeSelfDestructingVideoNote"
    ))]
    SelfDestructingVideoNote,
    /// The file is a self-destructing voice note in a private chat
    #[serde(rename(
        serialize = "fileTypeSelfDestructingVoiceNote",
        deserialize = "fileTypeSelfDestructingVoiceNote"
    ))]
