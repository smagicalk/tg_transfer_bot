...
pub enum MessageFileType {
    ...
    #[serde(rename(
        serialize = "messageFileTypePrivate",
        deserialize = "messageFileTypePrivate"
    ))]
    Private(crate::types::MessageFileTypePrivate),
    /// The messages were exported from a group chat
    #[serde(rename(
        serialize = "messageFileTypeGroup",
        deserialize = "messageFileTypeGroup"
    ))]
    Group(crate::types::MessageFileTypeGroup),
    /// The messages were exported from a chat of unknown type
    #[serde(rename(
        serialize = "messageFileTypeUnknown",
        deserialize = "messageFileTypeUnknown"
    ))]
    Unknown,
}
