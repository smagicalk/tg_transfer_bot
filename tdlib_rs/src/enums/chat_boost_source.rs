...
pub enum ChatBoostSource {
    ...
    #[serde(rename(
        serialize = "chatBoostSourceGiftCode",
        deserialize = "chatBoostSourceGiftCode"
    ))]
    GiftCode(crate::types::ChatBoostSourceGiftCode),
    /// The chat created a giveaway
    #[serde(rename(
        serialize = "chatBoostSourceGiveaway",
        deserialize = "chatBoostSourceGiveaway"
    ))]
    ...
    #[serde(rename(
        serialize = "chatBoostSourcePremium",
        deserialize = "chatBoostSourcePremium"
    ))]
