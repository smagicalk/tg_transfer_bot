...
pub enum DateTimeFormattingType {
    ...
    #[serde(rename(
        serialize = "dateTimeFormattingTypeRelative",
        deserialize = "dateTimeFormattingTypeRelative"
    ))]
    Relative,
    /// The date and time must be shown as absolute timestamps
    #[serde(rename(
        serialize = "dateTimeFormattingTypeAbsolute",
        deserialize = "dateTimeFormattingTypeAbsolute"
    ))]
