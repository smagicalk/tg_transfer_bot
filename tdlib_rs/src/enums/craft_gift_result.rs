...
pub enum CraftGiftResult {
    ...
    #[serde(rename(
        serialize = "craftGiftResultSuccess",
        deserialize = "craftGiftResultSuccess"
    ))]
    ...
    #[serde(rename(
        serialize = "craftGiftResultTooEarly",
        deserialize = "craftGiftResultTooEarly"
    ))]
    TooEarly(crate::types::CraftGiftResultTooEarly),
    /// Crafting isn't possible because one of the gifts isn't suitable for crafting
    #[serde(rename(
        serialize = "craftGiftResultInvalidGift",
        deserialize = "craftGiftResultInvalidGift"
    ))]
    InvalidGift,
    /// Crafting has failed
