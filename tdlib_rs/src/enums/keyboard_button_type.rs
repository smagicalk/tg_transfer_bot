...
pub enum KeyboardButtonType {
    ...
    #[serde(rename(
        serialize = "keyboardButtonTypeRequestUsers",
        deserialize = "keyboardButtonTypeRequestUsers"
    ))]
    RequestUsers(crate::types::KeyboardButtonTypeRequestUsers),
    /// A button that requests a chat to be shared by the current user; available only in private chats. Use the method shareChatWithBot to complete the request
    #[serde(rename(
        serialize = "keyboardButtonTypeRequestChat",
        deserialize = "keyboardButtonTypeRequestChat"
    ))]
    RequestChat(crate::types::KeyboardButtonTypeRequestChat),
    /// A button that opens a Web App by calling getWebAppUrl
    #[serde(rename(
        serialize = "keyboardButtonTypeWebApp",
        deserialize = "keyboardButtonTypeWebApp"
    ))]
