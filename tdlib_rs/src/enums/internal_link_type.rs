...
pub enum InternalLinkType {
    ...
    #[serde(rename(
        serialize = "internalLinkTypeAttachmentMenuBot",
        deserialize = "internalLinkTypeAttachmentMenuBot"
    ))]
    AttachmentMenuBot(Box<crate::types::InternalLinkTypeAttachmentMenuBot>),
    /// The link contains an authentication code. Call checkAuthenticationCode with the code if the current authorization state is authorizationStateWaitCode
    #[serde(rename(
        serialize = "internalLinkTypeAuthenticationCode",
        deserialize = "internalLinkTypeAuthenticationCode"
    ))]
    ...
    #[serde(rename(
        serialize = "internalLinkTypeBackground",
        deserialize = "internalLinkTypeBackground"
    ))]
    ...
    #[serde(rename(
        serialize = "internalLinkTypeBotAddToChannel",
        deserialize = "internalLinkTypeBotAddToChannel"
    ))]
    ...
    #[serde(rename(
        serialize = "internalLinkTypeBotStart",
        deserialize = "internalLinkTypeBotStart"
    ))]
    ...
    #[serde(rename(
        serialize = "internalLinkTypeBotStartInGroup",
        deserialize = "internalLinkTypeBotStartInGroup"
    ))]
    ...
    #[serde(rename(
        serialize = "internalLinkTypeBusinessChat",
        deserialize = "internalLinkTypeBusinessChat"
    ))]
    BusinessChat(crate::types::InternalLinkTypeBusinessChat),
    /// The link is a link to the Call tab or page
    #[serde(rename(
        serialize = "internalLinkTypeCallsPage",
        deserialize = "internalLinkTypeCallsPage"
    ))]
    ...
    #[serde(rename(
        serialize = "internalLinkTypeChatAffiliateProgram",
        deserialize = "internalLinkTypeChatAffiliateProgram"
    ))]
    ...
    #[serde(rename(
        serialize = "internalLinkTypeChatBoost",
        deserialize = "internalLinkTypeChatBoost"
    ))]
    ...
    #[serde(rename(
        serialize = "internalLinkTypeChatFolderInvite",
        deserialize = "internalLinkTypeChatFolderInvite"
    ))]
    ...
    #[serde(rename(
        serialize = "internalLinkTypeChatInvite",
        deserialize = "internalLinkTypeChatInvite"
    ))]
    ChatInvite(crate::types::InternalLinkTypeChatInvite),
    /// The link is a link that allows to select some chats
    #[serde(rename(
        serialize = "internalLinkTypeChatSelection",
        deserialize = "internalLinkTypeChatSelection"
    ))]
    ChatSelection,
    /// The link is a link to the Contacts tab or page
    #[serde(rename(
        serialize = "internalLinkTypeContactsPage",
        deserialize = "internalLinkTypeContactsPage"
    ))]
    ...
    #[serde(rename(
        serialize = "internalLinkTypeDirectMessagesChat",
        deserialize = "internalLinkTypeDirectMessagesChat"
    ))]
    ...
    #[serde(rename(
        serialize = "internalLinkTypeGame",
        deserialize = "internalLinkTypeGame"
    ))]
    ...
    #[serde(rename(
        serialize = "internalLinkTypeGiftAuction",
        deserialize = "internalLinkTypeGiftAuction"
    ))]
    ...
    #[serde(rename(
        serialize = "internalLinkTypeGiftCollection",
        deserialize = "internalLinkTypeGiftCollection"
    ))]
    ...
    #[serde(rename(
        serialize = "internalLinkTypeGroupCall",
        deserialize = "internalLinkTypeGroupCall"
    ))]
    ...
    #[serde(rename(
        serialize = "internalLinkTypeInstantView",
        deserialize = "internalLinkTypeInstantView"
    ))]
    InstantView(crate::types::InternalLinkTypeInstantView),
    /// The link is a link to an invoice. Call getPaymentForm with the given invoice name to process the link
    #[serde(rename(
        serialize = "internalLinkTypeInvoice",
        deserialize = "internalLinkTypeInvoice"
    ))]
    ...
    #[serde(rename(
        serialize = "internalLinkTypeLanguagePack",
        deserialize = "internalLinkTypeLanguagePack"
    ))]
    ...
    #[serde(rename(
        serialize = "internalLinkTypeLiveStory",
        deserialize = "internalLinkTypeLiveStory"
    ))]
    ...
    #[serde(rename(
        serialize = "internalLinkTypeMainWebApp",
        deserialize = "internalLinkTypeMainWebApp"
    ))]
    ...
    #[serde(rename(
        serialize = "internalLinkTypeMessage",
        deserialize = "internalLinkTypeMessage"
    ))]
    Message(crate::types::InternalLinkTypeMessage),
    /// The link contains a message draft text. A share screen needs to be shown to the user, then the chosen chat must be opened and the text is added to the input field
    #[serde(rename(
        serialize = "internalLinkTypeMessageDraft",
        deserialize = "internalLinkTypeMessageDraft"
    ))]
    MessageDraft(crate::types::InternalLinkTypeMessageDraft),
    /// The link is a link to the My Profile application page
    #[serde(rename(
        serialize = "internalLinkTypeMyProfilePage",
        deserialize = "internalLinkTypeMyProfilePage"
    ))]
    MyProfilePage(crate::types::InternalLinkTypeMyProfilePage),
    /// The link is a link to the screen for creating a new channel chat
    #[serde(rename(
        serialize = "internalLinkTypeNewChannelChat",
        deserialize = "internalLinkTypeNewChannelChat"
    ))]
    NewChannelChat,
    /// The link is a link to the screen for creating a new group chat
    #[serde(rename(
        serialize = "internalLinkTypeNewGroupChat",
        deserialize = "internalLinkTypeNewGroupChat"
    ))]
    NewGroupChat,
    /// The link is a link to the screen for creating a new private chat with a contact
    #[serde(rename(
        serialize = "internalLinkTypeNewPrivateChat",
        deserialize = "internalLinkTypeNewPrivateChat"
    ))]
    NewPrivateChat,
    /// The link is a link to open the story posting interface
    #[serde(rename(
        serialize = "internalLinkTypeNewStory",
        deserialize = "internalLinkTypeNewStory"
    ))]
    ...
    #[serde(rename(
        serialize = "internalLinkTypeOauth",
        deserialize = "internalLinkTypeOauth"
    ))]
    Oauth(crate::types::InternalLinkTypeOauth),
    /// The link contains a request of Telegram passport data. Call getPassportAuthorizationForm with the given parameters to process the link if the link was received from outside of the application; otherwise, ignore it
    #[serde(rename(
        serialize = "internalLinkTypePassportDataRequest",
        deserialize = "internalLinkTypePassportDataRequest"
    ))]
    ...
    #[serde(rename(
        serialize = "internalLinkTypePhoneNumberConfirmation",
        deserialize = "internalLinkTypePhoneNumberConfirmation"
    ))]
    PhoneNumberConfirmation(crate::types::InternalLinkTypePhoneNumberConfirmation),
    /// The link is a link to the Premium features screen of the application from which the user can subscribe to Telegram Premium. Call getPremiumFeatures with the given referrer to process the link
    #[serde(rename(
        serialize = "internalLinkTypePremiumFeaturesPage",
        deserialize = "internalLinkTypePremiumFeaturesPage"
    ))]
    ...
    #[serde(rename(
        serialize = "internalLinkTypePremiumGiftCode",
        deserialize = "internalLinkTypePremiumGiftCode"
    ))]
    ...
    #[serde(rename(
        serialize = "internalLinkTypePremiumGiftPurchase",
        deserialize = "internalLinkTypePremiumGiftPurchase"
    ))]
    PremiumGiftPurchase(crate::types::InternalLinkTypePremiumGiftPurchase),
    /// The link is a link to a proxy. Call addProxy with the given parameters to process the link and add the proxy
    #[serde(rename(
        serialize = "internalLinkTypeProxy",
        deserialize = "internalLinkTypeProxy"
    ))]
    ...
    #[serde(rename(
        serialize = "internalLinkTypePublicChat",
        deserialize = "internalLinkTypePublicChat"
    ))]
    ...
    #[serde(rename(
        serialize = "internalLinkTypeQrCodeAuthentication",
        deserialize = "internalLinkTypeQrCodeAuthentication"
    ))]
    QrCodeAuthentication,
    /// The link forces restore of App Store purchases when opened. For official iOS application only
    #[serde(rename(
        serialize = "internalLinkTypeRestorePurchases",
        deserialize = "internalLinkTypeRestorePurchases"
    ))]
    RestorePurchases,
    /// The link is a link to the Saved Messages chat. Call createPrivateChat with getOption("my_id") and open the chat
    #[serde(rename(
        serialize = "internalLinkTypeSavedMessages",
        deserialize = "internalLinkTypeSavedMessages"
    ))]
    SavedMessages,
    /// The link is a link to the global chat and messages search field
    #[serde(rename(
        serialize = "internalLinkTypeSearch",
        deserialize = "internalLinkTypeSearch"
    ))]
    Search,
    /// The link is a link to application settings
    #[serde(rename(
        serialize = "internalLinkTypeSettings",
        deserialize = "internalLinkTypeSettings"
    ))]
    Settings(crate::types::InternalLinkTypeSettings),
    /// The link is a link to the Telegram Star purchase section of the application
    #[serde(rename(
        serialize = "internalLinkTypeStarPurchase",
        deserialize = "internalLinkTypeStarPurchase"
    ))]
    ...
    #[serde(rename(
        serialize = "internalLinkTypeStickerSet",
        deserialize = "internalLinkTypeStickerSet"
    ))]
    ...
    #[serde(rename(
        serialize = "internalLinkTypeStory",
        deserialize = "internalLinkTypeStory"
    ))]
    ...
    #[serde(rename(
        serialize = "internalLinkTypeStoryAlbum",
        deserialize = "internalLinkTypeStoryAlbum"
    ))]
    StoryAlbum(crate::types::InternalLinkTypeStoryAlbum),
    /// The link is a link to a cloud theme. TDLib has no theme support yet
    #[serde(rename(
        serialize = "internalLinkTypeTheme",
        deserialize = "internalLinkTypeTheme"
    ))]
    Theme(crate::types::InternalLinkTypeTheme),
    /// The link is an unknown tg: link. Call getDeepLinkInfo to process the link
    #[serde(rename(
        serialize = "internalLinkTypeUnknownDeepLink",
        deserialize = "internalLinkTypeUnknownDeepLink"
    ))]
    ...
    #[serde(rename(
        serialize = "internalLinkTypeUpgradedGift",
        deserialize = "internalLinkTypeUpgradedGift"
    ))]
    ...
    #[serde(rename(
        serialize = "internalLinkTypeUserPhoneNumber",
        deserialize = "internalLinkTypeUserPhoneNumber"
    ))]
    ...
    #[serde(rename(
        serialize = "internalLinkTypeUserToken",
        deserialize = "internalLinkTypeUserToken"
    ))]
    ...
    #[serde(rename(
        serialize = "internalLinkTypeVideoChat",
        deserialize = "internalLinkTypeVideoChat"
    ))]
    ...
    #[serde(rename(
        serialize = "internalLinkTypeWebApp",
        deserialize = "internalLinkTypeWebApp"
    ))]
