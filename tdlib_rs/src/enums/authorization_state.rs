...
pub enum AuthorizationState {
    ...
    #[serde(rename(
        serialize = "authorizationStateWaitPremiumPurchase",
        deserialize = "authorizationStateWaitPremiumPurchase"
    ))]
    WaitPremiumPurchase(crate::types::AuthorizationStateWaitPremiumPurchase),
    /// TDLib needs the user's email address to authorize. Call setAuthenticationEmailAddress to provide the email address, or directly call checkAuthenticationEmailCode with Apple ID/Google ID token if allowed
    #[serde(rename(
        serialize = "authorizationStateWaitEmailAddress",
        deserialize = "authorizationStateWaitEmailAddress"
    ))]
    WaitEmailAddress(crate::types::AuthorizationStateWaitEmailAddress),
    /// TDLib needs the user's authentication code sent to an email address to authorize. Call checkAuthenticationEmailCode to provide the code
    #[serde(rename(
        serialize = "authorizationStateWaitEmailCode",
        deserialize = "authorizationStateWaitEmailCode"
    ))]
