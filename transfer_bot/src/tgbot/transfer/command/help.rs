...
use keyboard::{
    build_help_detail_buttons, build_help_index_buttons, build_help_topic_navigation_rows,
};
...
pub(super) fn build_help_menu_topic_rows() -> Vec<Vec<tdlib_rs::types::InlineKeyboardButton>> {
